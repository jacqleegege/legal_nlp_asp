...
prompt_2 = """ Below are more examples:
% Text
...
prompt_3 = """Below are more examples:
% Text
% Alice is married under section 7703 for the year 2017. Alice files a joint return with her spouse for 2017. Alice's and her spouse's taxable income for the year 2017 is $42876.
...
prompt_4 = """Below are more examples:
% Text
...
prompt_5 = """ Below are more examples:
% Text
...
prompt_6="""Below are more examples:
% Text
...
prompt_7 = """Below are more examples:
% Text
...
:- halt.
"""
prompt_8="""Below are more examples:
% Text
...
llm_manager.chat_completion(prompt_2,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_3,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_4,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_5,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_6,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_7,print_result=True, max_new_tokens=2000)
llm_manager.chat_completion(prompt_8,print_result=True, max_new_tokens=2000)